...
const translations = {
  fr: {
    ...
    'hero.description': 'Français, anglais et la langue de votre côte',
  ...
  en: {
    ...
    'hero.description': 'French, English and the language of your coast',
  ...
  ru: {
    ...
    'hero.description': 'Французский, английский и язык вашего побережья',
  ...
  it: {
    ...
    'hero.description': 'Francese, inglese e la lingua della vostra costa',
