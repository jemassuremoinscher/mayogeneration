  ...
  return (
    ...
    >
      <img
        ...
        fetchPriority="high"
      />
      <div className="absolute inset-0 bg-gradient-to-b from-primary/60 to-primary/80" aria-hidden="true" />
      ...
      <div className="relative z-10 text-center text-primary-foreground px-4 pt-16 max-w-4xl mx-auto animate-fade-in">
        ...
        <Button
          ...
          className="text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
